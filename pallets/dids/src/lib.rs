//! Decentralised-Identifiers limited
//! Decentralised Identifiers Pallet Implementation Decentralised-Identifiers Limited
//! Features in v0.0.1
...
pub mod pallet {
	...
	impl<T: Config> Hooks<BlockNumberFor<T>> for Pallet<T> {
		fn offchain_worker(block_number: T::BlockNumber) {
			log::info!("Decentralised-Identifiers OCW");
